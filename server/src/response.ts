...
export function validate<R, S extends z.ZodSchema | null>(schema: S, fn: (req: S extends z.ZodSchema ? z.infer<S> : Request, res: Response, next: NextFunction) => R) {
	return async (req: Request, res: Response, next: NextFunction) => {
